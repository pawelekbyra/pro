...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-inline' https: data: blob:; worker-src 'self' blob:; script-src 'self' 'unsafe-inline' https: blob: https://talk.hyvor.com;">
