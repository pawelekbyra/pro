        ...
        <form id="tippingForm" class="elegant-modal-content">
            ...
            <div class="elegant-modal-footer">
                <div class="elegant-modal-footer-buttons">
                    ...
                    <button type="submit" id="tippingSubmitPaymentBtn" class="elegant-modal-btn elegant-modal-btn-submit" style="display: none;" data-translate-key="tippingSubmitPayment">Zapłać</button>
                </div>
            </div>
        </form>
    </div>
