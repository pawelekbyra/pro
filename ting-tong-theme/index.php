...
<div id="author-profile-modal" class="author-profile-modal" role="dialog" aria-modal="true" aria-hidden="true">
    <div class="author-profile-content">
        <div class="author-profile-header">
            <button class="author-profile-back-btn" data-action="close-author-profile-modal" aria-label="Close author profile">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg>
            </button>
            <h2 class="author-profile-username"></h2>
            <button class="author-profile-options-btn" aria-label="Options">
                <svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="2"></circle><circle cx="19" cy="12" r="2"></circle><circle cx="5" cy="12" r="2"></circle></svg>
            </button>
        </div>
        <div class="author-profile-body">
            <div class="author-info-section">
                <div class="author-avatar-container">
                    <img src="" alt="Author Avatar" class="author-profile-avatar">
                </div>
            ...
            <div class="author-actions">
                <button class="subscribe-btn" data-translate-key="profileSubscribe">Subskrybuj</button>
                <button class="dm-btn" aria-label="Direct Message">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                </button>
            </div>
            <div class="author-tabs">
                <button class="author-tab active" data-tab="videos">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z"></path></svg>
                </button>
                <button class="author-tab" data-tab="liked">
                    <svg viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16.5 10.5V6.75a4.5 4.5 0 00-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"></path></svg>
                </button>
            </div>
            <div class="author-tab-content active" id="videos-grid">
                <!-- Video thumbnails will be dynamically inserted here -->
            </div>
            <div class="author-tab-content" id="liked-grid">
                <div class="empty-state">
                    ...
                    <p data-translate-key="profileNoLikedVideos">Polubione filmy będą widoczne tutaj.</p>
                </div>
            </div>
        </div>
    </div>
