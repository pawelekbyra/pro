  ...
  TRANSLATIONS: {
    pl: {
      ...
      tippingStep1Desc: {
          ...
          en: "Want to create a Patron account? 🏆"
      },
      tippingCreateAccountLabel: {
          pl: "No raczej!",
          en: "Yes, create an account!"
      },
      emailPlaceholder: {
        pl: "(podaj mail na ktory otrzymasz klucze logowania)",
        en: "Enter your email for login credentials"
      },
      tippingEmailHint: {
          pl: "Na podany e-mail otrzymasz dane dostępu do logowania do sekcji dla patronów.",
          en: "You'll receive login details for the patron section to the provided email."
      },
      tippingStep2Desc: {
          pl: "Wybierz kwotę, którą chcesz wesprzeć projekt.",
          en: "Choose the amount you'd like to contribute."
      },
      ...
      tippingAmountHint: {
          ...
          en: "Every bit of support is appreciated!"
      },
      tippingStep3Desc: {
          pl: "Wprowadź dane płatności. Korzystamy z bezpiecznego operatora Stripe.",
          en: "Enter your payment details below. We use Stripe for secure payments."
      },
      profileAccessAlert: {
