export const Config = {
  ...
  TRANSLATIONS: {
    pl: {
      ...
      alreadyInstalledText: "Przecież już ściągnąłeś",
      alreadyInstalledToast: "Przecież już ściągnąłeś",
    ...
    en: {
      ...
      alreadyInstalledToast: "You've already installed it",
      installNotReadyText: "The app is not ready for installation yet. Please try again later.",
